...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SolutionApprovalEvent> solutionApprovedContainerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, consumerGroupId + "-rewards");
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, SolutionApprovalEvent.class.getName());
        DefaultKafkaConsumerFactory<String, SolutionApprovalEvent> cf = new DefaultKafkaConsumerFactory<>(props);
        ConcurrentKafkaListenerContainerFactory<String, SolutionApprovalEvent> factory =
